...
\begin{table}[H]
  \centering
  \begin{tabular}{|p{0.05\textwidth}|p{0.2\textwidth}|p{0.3\textwidth}|p{0.2\textwidth}|p{0.1\textwidth}|}
  \hline
  ...
  \hline
  4 & Formal Education & \begin{tabular}[t]{@{}l@{}}Compulsory School\\Apprenticeship\\Secondary School\\UEQ\footnote{University Entrance Qualification}\\Bachelor's Degree\\Master's Degree\\Doctorate (PhD)\\No / Other Degree\end{tabular} & - & - \\
  \hline
  ...
  \hline
  8 & Perception of Advertisement (11 Items -- Section \ref{subsec:theoretical_foundations_and_hypothesis_development_conceptualizing_perceived_advertising_credibility_a_multi-dimensional_framework_for_credibility}) & \begin{tabular}[t]{@{}l@{}}Strongly disagree\\Disagree\\Neutral\\Agree\\Strongly agree\end{tabular} & H1--H4 & \cite{huschensYouTrustChatGPT2023} \\
  \hline
  \end{tabular}
