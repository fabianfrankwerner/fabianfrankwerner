...
Companies, individuals, and marketers are using AI-generated content to automate and optimize business processes (Uzun, 2023). AIGC is applied as a new approach to content creation, supplementing traditional methods like Professional Generated Content (PGC) and User Generated Content (UGC). Unlike human-created content, AI-generated content is developed using generative AI techniques, allowing large volumes of content to be created and automated quickly. Key technologies such as machine learning and neural networks have drastically improved the precision and effectiveness of AI in content creation (Haupt et al., 2024). This rise of artificial intelligence offers new opportunities and challenges for marketing. Research in this area is evolving rapidly, meaning current studies can quickly become outdated as attitudes toward AI continue to develop (Hofmann, 2019).

\section{Problem Statement and Research Gap}\label{sec:introduction_problem_statement_and_research_gap}

The rise of AI has led to an increasing volume of AI-generated content, as its generation has become simpler and more accessible. This presents a challenge, as content generated by humans can no longer be reliably distinguished from that generated by AI (Uzun, 2023).
...
As transparency becomes more relevant and AI becomes an integral part of digital strategies, there is a growing interest in understanding how consumers judge the use of AI in advertising. The influence of AI-generated content on perceived credibility is particularly interesting (Bünte, 2018). However, based on the author's research, there is a significant gap in the literature regarding the influence of knowing (versus not knowing) that an advertising message was generated by AI on brand credibility. Furthermore, the impact of a consumer's general attitude toward AI on this credibility perception has not been sufficiently investigated.
...
To what extent does the transparent disclosure of AI-generated content in advertising impact its perceived credibility?
