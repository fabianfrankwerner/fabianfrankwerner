...
% \begin{table}[h] \centering \begin{tabular}{|p{0.05\textwidth}|p{0.3\textwidth}|p{0.35\textwidth}|p{0.1\textwidth}|p{0.1\textwidth}|} \hline \textbf{No.} & \textbf{Variable} & \textbf{Response Options} & \textbf{Hypothesis} & \textbf{Source} \ \hline 1 & Gender & Female, Male, Diverse & - & - \ \hline 2 & Age & [Open numerical input] & - & - \ \hline 3 & Country & Germany, Austria, Switzerland & - & - \ \hline 4 & Education Level & Primary/Secondary School, Apprenticeship, Intermediate School Certificate, (Vocational) Baccalaureate/Matura, Bachelor's Degree, Master's Degree, Doctorate (PhD) & - & - \ \hline 5 & Occupation & In Training, Student, Employee, Civil Servant, Self-employed, Unemployed/Job Seeking, Other & - & - \ \hline 6 & Attitude towards AI & 5-point Likert scale (1=Very negative to 5=Very positive) & H5-H8 & - \ \hline 7 & Perception of Advertisement (Competence, Trustworthiness, Clarity, Engagement) & 5-point Likert scale (1=Strongly disagree to 5=Strongly agree) for 11 items (e.g., accurate, honest, clear, interesting) & H1-H4 & Huschens et al. (2023) \ \hline \end{tabular} \caption{Components of the Questionnaire} \label{tab:questionnaire_components} \end{table}
