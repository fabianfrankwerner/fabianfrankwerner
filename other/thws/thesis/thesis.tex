...
Chapter \ref{ch:theoretical_foundations_and_hypothesis_development} builds the theoretical foundation for the study. It begins by defining AI within the context of digital advertising (Section 2.1). It then provides a detailed conceptualization of the study's dependent variable, perceived advertising credibility (Section 2.2), including the distinction between source and message credibility (2.2.1) and the multi-dimensional framework used for its measurement (2.2.2). Following this, the chapter reviews the literature on the independent variable, AI transparency, disclosure, and labeling (Section 2.3), and consumer responses to such content (2.3.2). A synthesis of the current research (Section 2.4) consolidates these findings, leading to the development of the conceptual framework and the formal hypotheses (Section 2.5).
