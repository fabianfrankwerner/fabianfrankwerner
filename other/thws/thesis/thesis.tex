...
While the distinction between source and message credibility is foundational, these concepts are themselves multi-dimensional. As established in the classic literature, source credibility is traditionally broken down into two primary components: competence and trustworthiness \cite{hovlandInfluenceSourceCredibility1951}. Message credibility, in turn, is often assessed by its perceived accuracy, balance, and quality \cite{metzgerCredibility21stCentury2003}.

To create a robust measurement model for the specific context of AI-generated content, this thesis will adopt a framework based on recent research in this domain \cite{huschensYouTrustChatGPT2023}. This model synthesizes the source and message levels into a single, four-dimensional framework for assessing content credibility. These four dimensions are:

\textbf{Competence}: This dimension reflects the perceived expertise and knowledgeability of the source, operationalized through items like \enquote{accurate,} \enquote{complete,} and \enquote{knowledgeable.}

\textbf{Trustworthiness}: This dimension captures the perceived honesty and reliability of the source, measured with items such as \enquote{honest,} \enquote{trustworthy,} and \enquote{reliable.}

% (Not) Confusing

\textbf{Clarity}: This dimension assesses the quality of the message itself, focusing on its comprehensibility. It is measured with items like \enquote{clear,} \enquote{not confusing,} and \enquote{understandable.}

\textbf{Engagement}: This dimension measures the content's ability to capture and hold the reader's attention, using items like \enquote{interesting} and \enquote{maintaining attention.}
